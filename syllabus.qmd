...
+=====================+================+====================================+
| Prof. Maria Tackett | Instructor     | Mon 1:30 - 2:30pm, Old Chem 118B   |
|                     |                |                                    |
|                     |                | Thu 3 - 4pm, Old Chem 118B         |
|                     |                |                                    |
|                     |                | *or by appointment*                |
+---------------------+----------------+------------------------------------+
| Kat Husar           | Head TA\       | Tue 1:30 - 3:30pm, TBD             |
|                     | Lab 02L leader |                                    |
+---------------------+----------------+------------------------------------+
| Jon Campbell        | Lab 01L leader |                                    |
+---------------------+----------------+------------------------------------+
| Ishrit Gupta        | Lab 01L helper |                                    |
+---------------------+----------------+------------------------------------+
...
All lecture notes, assignment instructions, an up-to-date schedule, and other course materials may be found on the course website, [sta221-fa24.netlify.app](https://sta221-fa24.netlify.app).
...
AEs will be graded based on making a good-faith effort in attempting all questions covered in class. You are welcome to, but not required, to work on AEs beyond lecture.
