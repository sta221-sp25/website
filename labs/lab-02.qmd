...
<!--# Next time do this lab using infant / toddler/ preschool costs-->
...
<!--# instead of using the average values, just choose a single year next time-->
...
Use the matrix form of the model to represent the regression model with the variables you selected and transformed/created in exercises 2 and 3 as the predictors. For each symbol in the model (1) describe what it represents and (2) state the dimensions. The description and dimensions should be in the context of these data, not in general.
