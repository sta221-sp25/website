...
Estimate regression coefficients $\hat{\boldsymbol{\beta}}$ for the model using `spend_per_resident_data` to explain variabilty in `park_near_pct_points` using the matrix representation. Show your work and/or code to get the answer.
