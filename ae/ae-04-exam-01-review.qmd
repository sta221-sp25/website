...
a.  The regression standard error $\hat{\sigma}_{\epsilon}^2$ . Interpret this value in the context of the data.
...
b.  Consider the following derivation of $Var(\hat{\boldsymbol{\beta}})$ , the variance of the least-squares estimator:
    ...
    $$
    \begin{aligned}
    Var(\hat{\boldsymbol{\beta}}) &= E[(\hat{\boldsymbol{\beta}} - E(\hat{\boldsymbol{\beta}}))^2]\\
...
Explain how to go from Line 2 to Line 3.

c.  What assumptions are used to go from Line 4 to Line 5?
