...
We can use a logistic regression model to understand the relationship between performance rating promotion. (We will discuss this in detail next class, but will get a preview for now.)
