...
-   Use the `vif` function to compute VIF for the predictors in Exercise 1.
...
Let's address the issue of mulitcollinearity. Choose a strategy to address the multicollinearity. Then, select a final model.
