...
Researchers at Wollo Univeristy in Ethiopia conducted a study in July and August 2020 to understand factors associated with good COVID-19 infection prevention practices at food establishments. Their study is published in @andualem2022.
...
while(delta > 0.000001 & iter < 50){
  old <- beta
  beta <- old - solve(calc_second_deriv(beta = beta, X = X, y = y)) %*% 
