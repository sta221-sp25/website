...
The goal of this analysis is to use the square feet of a home to understand variability in the price.
...
Let's begin by examining the univariate distributions of the variables of interest. The code to visualize and calculate summary statistics for `price` is below.
...
Woud this model be a reasonable fit for the data? Why or why not?
:::
