...
<!-- The anticipated length, including all graphs, tables, narrative, etc. with code, warnings, and messages suppressed is about 4 - 6 pages. -->
...
1.  A detailed abstract
2.  Slides summarizing your project results
3.  Short video summarizing your project results
