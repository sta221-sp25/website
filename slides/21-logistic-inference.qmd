...
-   Suppose there are two models:
    ...
    -   Full Model: includes predictors $x1, \ldots, x_q, x_{q+1}, \ldots, x_p$
...
The **deviance** is a measure of the degree to which the predicted values are different from the observed values
...
Note: $n - p - 1$ a the degrees of freedom associated with the residuals, i.e., error in the model
...
::: question
What is your conclusion? Would you include `education` in the model that already includes `age`, `totChol`, `education`?
:::
...
The expected value of $\hat{\boldsymbol{\beta}}$ is the true parameter, $\beta$, i.e., $E(\hat{\boldsymbol{\beta}}) = \boldsymbol{\beta}$
