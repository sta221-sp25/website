...
![Source: [*R for Data Science*](https://r4ds.hadley.nz/) with additions from *The Art of Statistics: How to Learn from Data*.](images/01/data-analysis-life-cycle.png){alt="Source: R for Data Science with additions from The Art of Statistics: How to Learn from Data."}

---

![Source:[*R for Data Science*](https://r4ds.hadley.nz/)](images/01/whole-game.png){alt="Source:R for Data Science"}
...
5.  The report will share the group's summary of key points and remaining questions with the class.
:::
...
![Source: [Statistical Inference via Data Science](https://moderndive.com/1-getting-started.html)](images/01/r_vs_rstudio_1.png){alt="Source: Statistical Inference via Data Science" fig-align="center"}
...
-   Complete readings to prepare for Thursday's lecture

-   Thursday: Review of simple linear regression
