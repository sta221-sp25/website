...
\sigma(\pi) = \frac{\exp\{\pi\}}{1 + \exp\{\pi\}}= \frac{1}{1+\text{exp}\{-\pi\}}.$$
...
ggplot(data, aes(x = x, y = y)) +
  ...
  labs(x = expression(pi), y = expression(sigma(pi))) +
...
$$
\begin{aligned}
L&(\boldsymbol\beta| x_i, \dots, x_n, y_i, \dots, y_n) \\[5pt]
...
$$
\begin{aligned}
\log &L(\boldsymbol\beta | x_i, \dots, x_n, y_i, \dots, y_n) 
  \\[8pt]
