...
-   **Read the feedback on Gradescope carefully!!** If you have questions about the comments, ask during office hours or before/after class.
...
Link to tidy tuesday data: <https://github.com/rfordatascience/tidytuesday/blob/master/data/2022/2022-03-29/readme.md>

<!--# Use the tidytuesday sports data set-->

<!--# filter out for sports == Football and for NCAA - Division 1 FBS-->

<!--# Look first at relationship between total population (divide by 1000) and total expenditure-->

<!--# Then look at total population and type of school (public private) and total expenditure)-->
...
p1 <- ggplot(data = football, aes(x = total_exp_m)) + 
  ...
  labs( x= "Total Football Expenditure (in $Millions)")
...
p4 <- ggplot(data = football, aes(x = enrollment_th, y = total_exp_m)) +
  geom_point() +
  labs(x = "Total Student Enrollment (in Thousands)", 
       y = "Total Football Expenditure (in $Millions)", 
       title = "Football Expenditure vs. Enrollment")
