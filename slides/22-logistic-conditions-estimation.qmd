...
&= \sum_{i=1}^n y_i x_i^T \boldsymbol\beta - \sum_{i=1}^n \log(1+ \exp\{x_i^T \beta\})
\end{aligned}
$$
...
$$
\begin{aligned}
\frac{\partial \log L}{\partial \boldsymbol\beta} =\sum_{i=1}^n y_i x_i^T
&- \sum_{i=1}^n \frac{\exp\{x_i^T \boldsymbol\beta\} x_i^T}{1+\exp\{x_i^T \boldsymbol\beta\}} = 0
\end{aligned}
$$
...
$$
\log L = \sum_{i=1}^n y_i x_i^T \boldsymbol\beta - \sum_{i=1}^n \log(1+ \exp\{x_i^T \beta\})
$$

$$
\nabla_{\boldsymbol{\beta}} \log L = \sum_{i=1}^n y_i x_i^T
- \sum_{i=1}^n \frac{\exp\{x_i^T \boldsymbol\beta\} x_i^T}{1+\exp\{x_i^T \boldsymbol\beta\}}
$$

$$
\nabla^2_{\boldsymbol{\beta}} \log L = \
- \sum_{i=1}^n \Big(\frac{1}{1+\exp\{x_i^T \boldsymbol\beta\}}\Big)\Big(\frac{\exp\{x_i^T \boldsymbol\beta\}}{1+\exp\{x_i^T \boldsymbol\beta\}}\Big)\mathbf{x}_i\mathbf{x}_i^T
$$

## PPE access example 

::: appex
📋 <https://sta221-fa24.netlify.app/ae/ae-07-newton-raphson.html>
:::
