...
-   When there are near-linear dependencies, the $C_{jj}$ increases and thus $Var(\hat{\beta}_j)$ .
-   The $C_{jj}$ is associated with how much $Var(\hat{\beta}_j)$ is inflated due to $x_j$ dependencies with other predictors
