...
-   One common type of centering is **mean-centering**, which every value of a predictor is shifted by its mean
...
-   Standardizing a quantitative predictor mean shifting every value by the mean and diving by the standard deviation of that variable
...
-   See [Prepare for Lecture 07](../prepare/prepare-lec07.html)
