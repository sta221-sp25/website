...
-   Review: Collinearity vs. interaction effects
...
# Collinearity vs. interations

## Collineairty 

\[use palmer penguin data set\]
...
\[UPDATE THIS TO CURRENT TOURNAMENT GAMES\]
...
$$OR = \frac{\omega_{18-29}}{\omega_{65+}} = \frac{0.756}{1.463} = \mathbf{0.517}$$
...
::: appex
📋 [sta210-sp25.netlify.app/ae/ae-09-prob-odds.html](../ae/ae-09-prob-odds.html) \[UPDATE LINK\]
:::
