...
b.  Under what condition does $E(\hat{\boldsymbol{\beta}}_1) = \boldsymbol{\beta}$ ? What is the relationship between $\mathbf{X}_1$ and $\mathbf{X}_2$ under this condition?
